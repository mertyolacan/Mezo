        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-100 dark:border-zinc-800">
              <th className="text-left px-4 py-3 font-medium text-zinc-500">Ticket</th>
              <th className="text-left px-4 py-3 font-medium text-zinc-500 hidden md:table-cell">Kullanıcı</th>
              <th className="text-left px-4 py-3 font-medium text-zinc-500 hidden lg:table-cell">Öncelik</th>
