        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-100 dark:border-zinc-800">
              <th className="text-left px-3 py-2.5 sm:px-4 sm:py-3 font-medium text-zinc-500">Sipariş No</th>
              <th className="text-left px-3 py-2.5 sm:px-4 sm:py-3 font-medium text-zinc-500 hidden md:table-cell">Müşteri</th>
            ...
            {rows.map((order) => {
              ...
              return (
                <tr key={order.id} className="border-b border-zinc-100 dark:border-zinc-800 last:border-0">
                  <td className="px-3 py-2.5 sm:px-4 sm:py-3 font-mono font-medium text-zinc-900 dark:text-zinc-50">{order.orderNumber}</td>
                  ...
                  <td className="px-3 py-2.5 sm:px-4 sm:py-3 font-semibold text-zinc-900 dark:text-zinc-50">
