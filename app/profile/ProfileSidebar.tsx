    ...
    <aside className="w-full md:w-52 shrink-0">
      <nav className="space-y-0.5">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-btn text-sm font-medium transition-colors ${
                active
                  ? "bg-brand-primary/10 dark:bg-brand-primary/20 text-brand-primary dark:text-brand-primary-light"
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-btn text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-950 transition-colors"
        >
