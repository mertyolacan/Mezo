      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
            ...
            <Link href="/kvkk" className="text-indigo-600 dark:text-indigo-400 hover:underline">
              Gizlilik Politikası
            </Link>
          </p>
          <div className="flex gap-2 mt-3">
            ...
            <button
              onClick={decline}
              className="flex-1 border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-xs font-medium py-2 rounded-lg transition-colors"
            >
              Reddet
            </button>
          </div>
